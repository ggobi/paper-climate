...
Computing the coordinates for star glyphs is achieved by using polar coordinates of $y_{\amin}$, and $x_{\amin}$,  $r$, the radius scaled to be between 0 and 1, and $\theta$, the angle. Then the glyph coordinates are given by 
