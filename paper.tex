...
Compare the facetted map Figure \ref{facetted-map} with the glyph-map
of de-seasonalized data in Figure \ref{fig:nasa-deseas-glyph}.
...
\begin{figure*}[htp]
\centerline{\includegraphics[width=6in]{nasa-deseas-glyph.png}}
\caption{Glyph-map of de-seasonalized temperature, to compare with Figure \ref{facetted-map}. }
