...
\begin{itemize}
  ...
  the continental United States (XXX locations), measured monthly (???) from
  XXX to YYY (ZZZ time points in total). Ground station data was
  de-seasonalized, differenced from ***, and spatially averaged to obtain
  gridded measurements
