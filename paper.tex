...
\begin{figure}[htbp]
  ...
  \caption{Glyph-maps of ground station temperature values, 2001-2010, for the mountain states and the entire United States.} % these aren't actually plotting the same thing.
  \label{fig:irregular}
\end{figure}
